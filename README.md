...
You can use [jitpack](https://jitpack.io) to add influxdb-java to your project or directly [download jar file](https://github.com/ashishdoneriya/influxdb-java/releases/download/2.5.2/influxdb-2.5.2.jar) 
